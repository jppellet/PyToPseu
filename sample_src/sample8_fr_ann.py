...
for i in range(9):                              #│   répète 9 fois (en comptant avec i̲ à partir de 0):
    print(i)                                    #│   │   affiche i̲
                                                #│   
for i in range(n):                              #│   répète n̲ fois (en comptant avec i̲ à partir de 0):
    print(i)                                    #│   │   affiche i̲
                                                #│   
for i in range(n + n*2):                        #│   répète ⟨la somme de n̲ et ⟨le produit n̲ × 2⟩⟩ fois (en comptant avec i̲ à partir de 0):
    print(i)                                    #│   │   affiche i̲
                                                #│   
for i in n:                                     #│   répète pour chaque élément de n̲ (qu'on va appeler i̲):
    print(i)                                    #│   │   affiche i̲
                                                #│   
...
for char in word:                               #│   répète pour chaque élément de w̲o̲r̲d̲ (qu'on va appeler c̲h̲a̲r̲):
    print(i, char)                              #│   │   affiche i̲ et c̲h̲a̲r̲
                                                #│   
# (c)                                           #│   
word = "Hello"                                  #│   dans w̲o̲r̲d̲, stocke "Hello"
for i, char in enumerate(word):                 #│   répète pour chaque élément de w̲o̲r̲d̲
...
for i, character in enumerate(range(len(s))):   #│   répète pour chaque élément de la plage de 0 à ⟨la longueur de s̲⟩
